"""Regression checks for the quartz-lang-type-dock casebook."""
...
from casebook.harness import assert_expected, quartz_lang_type_dock_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(quartz_lang_type_dock_summary(), assert_expected())
